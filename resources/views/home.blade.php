            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <p>
                        ...
                        Outdoor is safer than indoor for gatherings or holding events. People who
                        get sick with Coronavirus disease (COVID-19) will experience mild to
                        moderate symptoms and recover without special treatments.
                    </p>
                    <p>
                        You can feel free to use this CSS template for your medical profession or
                        health care related websites. You can support us a little via PayPal if
                        this template is good and useful for your work.
                    </p>
                </div>
                    ...
                    @foreach($resources as $resource)
                        <div class="col-md-4 mb-4">
                            <div class="card h-100 shadow-sm">
                                ...
                                @if($resource->image)
                                    <img src="{{ asset('storage/images/' . $resource->image) }}" 
                                         class="card-img-top" 
                                         alt="{{ $resource->title }}"
                                         style="height: 200px; object-fit: cover;">
                                @else
                                    <img src="{{ asset('assets/images/default-resource.jpg') }}" 
                                         class="card-img-top" 
